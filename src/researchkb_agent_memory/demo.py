...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Examples directory. Defaults to ./examples, falling back to the repository copy.",
    )
    ...
    examples_dir = args.examples or default_examples_dir()
    db_path = seed_demo_db(args.root, examples_dir, force=args.force, include_runs=args.include_run)
...
def default_examples_dir() -> Path:
    ...
    return packaged if packaged.exists() else EXAMPLES_DIR
